    ...
    <SafeAreaView style={styles.container}>
      ...
      >
        ...
        <TouchableOpacity
          style={styles.button}
          onPress={() =>
            navigation.navigate("Cache Info", { pagename: "STUDIO B" })
          }
        >
          <Image
            source={require("../../assets/studioB.jpg")}
            style={{ width: 250, height: 332.5 }}
          />
        ...
        <TouchableOpacity
          style={styles.button}
          onPress={() =>
            navigation.navigate("Cache Info", { pagename: "STUDIO A" })
          }
        >
          <Image
            source={require("../../assets/studioA.jpg")}
            style={{ width: 250, height: 332.5 }}
          />
        ...
        <TouchableOpacity
          style={styles.button}
          onPress={() =>
            navigation.navigate("Cache Info", { pagename: "ROOM 3100" })
          }
        >
          <Image
            source={require("../../assets/3100.jpg")}
            style={{ width: 250, height: 332.5 }}
          />
