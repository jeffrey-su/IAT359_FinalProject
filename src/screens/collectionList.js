  ...
  async function getUsername() {
    ...
    querySnapshot.forEach((doc) => {
      if (doc.id == firebase_auth.currentUser.email) {
        ...
        allcomments.push(`${doc.data().username}`);
      }
    });
      ...
      >
        <SafeAreaView style={{ flexDirection: "row", marginTop: "10%" }}>
          <Image
            source={
              studioABadge
                ? require("../../assets/studioABadge.png")
                : require("../../assets/studioABadgeLocked.png")
            }
          ...
          <Image
            source={
              studioBBadge
                ? require("../../assets/studioBBadge.png")
                : require("../../assets/studioBBadgeLocked.png")
            }
          ...
          <Image
            source={
              macLabBadge
                ? require("../../assets/macLabBadge.png")
                : require("../../assets/macLabBadgeLocked.png")
            }
        ...
        <SafeAreaView style={{ flexDirection: "row", marginTop: "10" }}>
          <Text style={[styles.badgeText, { paddingBottom: 30 }]}>
            Studio A Badge
          </Text>
          <Text style={[styles.badgeText, { paddingBottom: 30 }]}>
            Studio B Badge
